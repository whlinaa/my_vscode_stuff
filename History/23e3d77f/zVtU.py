...
# %%
print("hello")
print(os.path.basename('/tmp/abc/efg/test.txt'))
print(os.path.dirname('/tmp/abc/efg/test.txt'))
print(os.path.splittext('/tmp/abc/efg/test.txt'))
# os.path.split('/tmp/abc/efg/test.txt')
