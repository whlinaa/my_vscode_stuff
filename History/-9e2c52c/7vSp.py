...
def value_counts_plus(
    ...
    show_prop: bool = True,
    show_cum: bool = False, # if True, then cum of both count and prop are shown
    index_name: str | bool = False, # user-specified index name
    as_pct: bool = False,
    ) -> pd.DataFrame:
