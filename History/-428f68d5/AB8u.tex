...
\part Write down the distribution function of the random variable $Y=X+R+1$, where $R$ is the last digit of your student ID. 
\end{parts}
% \vspace*{\stretch{1}}
% \newpage
...
$$
g(y)= \begin{cases}0.3 & \text { for } y=2 \\ 0.2 & \text { for } y=3 \\ 0.5 & \text { for } y=6 \\ 0 & \text { otherwise. }\end{cases}
$$
