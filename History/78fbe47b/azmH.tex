...
\begin{parts}
% Q10, ex3.7, CZ
\part Does there exists two real numbers $a>R$ and $b>R$ such that $\sqrt{a+R}+\sqrt{b+R} = \sqrt{a+b+2R}$? If so, find $a$ and $b$. If not, prove such a pair does not exist.
