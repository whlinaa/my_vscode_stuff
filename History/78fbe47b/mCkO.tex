...
\begin{parts}
% Q10, ex3.7, CZ
\part Does there exists a pair of positive real numbers $a$ and $b$ and $a>R$ and $b>R$ such that $\sqrt{a+R}+\sqrt{b+R} = \sqrt{a+b+2R}$? If so, find it. If not, prove such a pair does not exist.
