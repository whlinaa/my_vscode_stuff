...
\begin{parts}
  ...
  \end{subparts}
  \part Suppose that instead of leaving for Station $B$ at 9:00am, the train at Station $A$ now leaves for Station $B$ k minutes earlier than 9:00am. Find the value of $k$ if the probability that Peter reaches Station $B$ by 9:55am is now 0.9
\end{parts}
