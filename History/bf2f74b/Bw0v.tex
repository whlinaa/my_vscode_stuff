...
\begin{parts}
  ...
  \end{subparts}
  \part Suppose that instead of leaving for Station $B$ at 9:00am, the train at Station $A$ now leaves for Station $B$ $k$ minutes later than 9:00am. Find the value of $k$ if the probability that Peter reaches Station $B$ by 10:06am is now 0.6
\end{parts}
