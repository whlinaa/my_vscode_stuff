...
\begin{parts}
  ...
  \part Suppose that instead of leaving for Station $B$ at 9:00am, the train at Station $A$ now leaves for Station $B$ $m$ minutes later than 9:00am. Find the value of $m$ if the probability that Peter reaches Station $B$ later than 10:06am is now 0.6.
\end{parts}
