...
my_parser.add_argument('input', action='store', help='optional positional argument with default', nargs='?', default='input_default')
my_parser.add_argument('-a', '--add', '--addition', action='store', help='store the input', metavar='CONST')
...
my_parser.add_argument('-p', action='store', help='0 or 1 argument, with default', default=12345)
my_parser.add_argument('-q', action='store', help='with allowed values', choices=['head', 'tail'])
my_parser.add_argument('-r', action='store', help='with allowed values', type=int, choices=range(3))
my_parser.add_argument('-street', action='store', help='with allowed values', type=int, choices=range(3))
