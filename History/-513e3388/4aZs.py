...
my_parser.add_argument('-l', action='store', nargs=3)
my_parser.add_argument('-m', action='store', nargs='*', help='')
my_parser.add_argument('-n', action='store', nargs='+', help='')
my_parser.add_argument('-o', action='store', nargs='?', help='')
