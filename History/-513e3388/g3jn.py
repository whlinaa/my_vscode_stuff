...
my_parser.add_argument('-a', action='store', help='store the input')
my_parser.add_argument('-b', action='store_const', const=42, help='store a pre-defined constant')
my_parser.add_argument('-c', action='store_true') # store True value if specified
my_parser.add_argument('-d', action='store_false')
my_parser.add_argument('-e', action='append') # 
my_parser.add_argument('-f', action='append_const', const=42) # given a constant, append it n times if the option is specified n times
my_parser.add_argument('-g', action='count') # count how many times `-g` has been specified
my_parser.add_argument('-i', action='help') # give another option to show help page
