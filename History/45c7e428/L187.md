...
- HKT includes
	...
	- now tv
	- the club
	- The Club is HKT’s customer loyalty programme and digital ventures arm. Anyone can join the programme for free and enjoy the rewards, privileges, and services such as online shopping, travel, insurance, and community. Members can earn Clubpoints from spending through The Club’s digital services, designated HKT affiliate services, or partnered merchants. Clubpoints can be used to redeem rewards or deduct spending on the various The Club digital services.
- why HKT?
	- have all types of data
		- transaction data
			- good for predictive modelling
		- time series data
			- time series forecasting
			- the mobile data usage for different timestamps
		- customer behavior data
			- recommender system
	- big data technology (apache spark)
	- fellow colleagues are strong, and so I can learn from them
		- ho wa, whom I met in the first round, is also from HKUST, and is very good, evidenced from the fact that he was in the programming team and FYP supervised by one of the most academically demanding supervisor
	- 
...
## challenging parts of your work at MassMutual
- define the business problem to solve
	- ensure the model we build can generate profit to our company
	- make SaaS products for other insurance companies.
	- need to understand what our clients think useful
	- shortlist several promising models, and then interview people from some major insurance companies.
		- ask them to rank each of the models based on usefulness
		- then do some statistical analysis on the responses
		- then decide which model to build, by considering the responses of the insurers, feasibility, availability of data, manpower, time needed
			- e.g., some insurers wanted us to build NLP models to digitalize hand-written insurance application form. We simply can't do it because we lack data
	- research
