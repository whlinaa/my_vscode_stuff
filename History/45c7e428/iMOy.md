...
- project on predictive modelling: classification project from kaggle competition, with the feature names masked to avoid
...
# k-means:
- `k-means++` is chosen as the default initialization method for cluster centroids in sklearn
