...
\begin{choices}
  \choice when conducting sign test for paired samples, our null hypothesis is that the two populations have the same median.
...
\begin{choices}
  ...
  \choice[*] type-1 error will decrease, and type-2 error will decrease.
