...
# parser.add_argument('path', action='store', help='optional positional argument with default', default='ff')
parser.add_argument('-e', '--ext', action='store', help='change the files with given extension only')
parser.add_argument('-p', '--prefix', action='store', help='add the prefix to all files')
parser.add_argument('-s', '--suffix', action='store', help='add the suffix to all files')
parser.add_argument('-i', '--ignore_hidden', action='store', help='ignore hidden files')
parser.add_argument('-r', '--recursive', action='store', help='rename recursively')
