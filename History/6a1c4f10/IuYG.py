...
# ex: Callable[..., int]
# ex: Sequence[int]
# ex TypeVar('pd.io.formats.style.Styler')
from typing import Any, Optional, Iterator, TypeVar, Callable, Iterable, Sequence, overload
...
# %%
PandasStyler = TypeVar('pd.io.formats.style.Styler')
