...
\begin{parts}
  ...
  \part What is the least number of additional samples needed to select if the company wishes to be $98 \%$ confident that the estimate of mean chemical levels from Station 1 will be within $1.0 \mathrm{mg} /$ liter of the true population mean?
\end{parts}
