...
## origins of some names in evaluation metrics
...
- when we say PR curve, we should plot precision against recall (i.e, precision is y-axis, recall is x-axis)
- for ROC, we have recall (TPR) against FPR
...
## specialized metrics
- for audio: latency, throughput (how many queries we handle)
