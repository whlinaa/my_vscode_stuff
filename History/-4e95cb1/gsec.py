...
def add_prefix_suffix(path, ext='', prefix='', suffix='', change_hidden=False, recursive=False, timestamp=False):
...
parser.add_argument('path', action='store', help='location of the file. Defaults to None', nargs='?', default=None)
...
parser.add_argument('-i', '--change_hidden', action='store_true', help='show hidden files', default=False)
...
if args['path']: 
    ...
    add_prefix_suffix(
        ...
        prefix=args['prefix'], 
        suffix=args['suffix'], 
        change_hidden=args['ignore_hidden'], 
