...
def add_prefix_suffix(path, ext='', prefix='', suffix='', show_hidden=False, recursive=False, timestamp=False):
...
parser.add_argument('-i', '--show_hidden', action='store_true', help='show hidden files', default=False)
...
if args['path']: 
    ...
    add_prefix_suffix(
        ...
        prefix=args['prefix'], 
        suffix=args['suffix'], 
        show_hidden=args['ignore_hidden'], 
