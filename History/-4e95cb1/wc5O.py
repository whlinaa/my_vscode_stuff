...
def add_prefix_suffix(path, ext='', prefix='', suffix='', hidden=False, recursive=False, timestamp=False):
...
parser.add_argument('-h', '--hidden', action='store_true', help='ignore hidden files', default=False)
